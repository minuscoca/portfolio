...
export function Navbar() {
  return (
    <header className="fixed top-0 z-50 flex w-full items-center justify-center sm:left-0 sm:right-0 sm:p-4">
      <nav className="flex w-full flex-wrap items-center justify-center border border-border bg-background/40 px-8 py-4 sm:py-2 backdrop-blur-lg sm:w-fit sm:rounded-full">
